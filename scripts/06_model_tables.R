...
#### 2a - LOAD LTER MODELS  ##### 
load("users/egallois/soilcores/models/async_temp_comm_quantile.RData") # async_temp_comm
load("users/egallois/soilcores/models/biomass_temp_comm_quantile.RData") # biomass_temp_comm
load("users/egallois/soilcores/models/rate_temp_comm_quantile.RData") # rate_temp_comm
...
# Save in csv
write.csv(mod.table.final, "users/egallois/soilcores/outputs/roots_model_table.csv")
...
# Convert to table
stargazer(mod.table.final, type = "html",  summary = FALSE, out = "users/egallois/soilcores/outputs/roots_model_table.html")
