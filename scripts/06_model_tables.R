...
#### 2a - LOAD LTER MODELS  ##### 
load("models/async_temp_comm_quantile.RData") # async_temp_comm
load("models/biomass_temp_comm_skew_quantile.RData") # biomass_temp_comm_skew
load("models/rate_temp_comm_quantile.RData") # rate_temp_comm
...
models.list <- list(biomass_temp_comm_skew, rate_temp_comm, async_temp_comm)
...
# Save in csv
write.csv(mod.table.final, "outputs/roots_model_table_quantile_2024.csv")
...
# 3 - Continuous models ----
load("models/async_temp_cont_quantile.RData") # async_temp_continuous
load("models/biomass_temp_continuous.RData") # biomass_temp_continuous
load("models/rate_temp_continuous_quantile.RData") # rate_temp_continuous
...
# Save in csv
write.csv(mod.table.final, "outputs/roots_model_table_continuous_2024.csv")
