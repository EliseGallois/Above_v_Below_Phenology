...
# save model output
save(rq1_biomass_temp, file = "users/egallois/soilcores/models/biomass_temp.RData")
...
# save model output
save(biomass_temp_comm, file = "users/egallois/soilcores/models/biomass_temp_comm_quantile.RData")
...
# save model output
save(rate_temp_comm, file = "users/egallois/soilcores/models/rate_temp_comm_quantile.RData")
...
# save model output
save(async_temp_comm, file = "users/egallois/soilcores/models/async_temp_comm_quantile.RData")
