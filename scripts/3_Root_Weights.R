...
(too_greening_curves <- phenocam %>%
    ...
    geom_point(aes(shape = PLOT), size = 2,  col = "#138513",  alpha = 0.6) +
    ...
    xlim(-5, 110) +
    ylim(0, 100)) 
(too_greening_curves <- too_greening_curves  + theme(legend.position = "none"))
...
(too_root_rate <- growth_rates %>%
    ...
    geom_point(aes(shape = Phenocam), size = 2, alpha = 0.3, colour = "#5C4523") +
    scale_shape_manual(values = 1:10) +
...
(cair_greening_curves <- phenocam %>%
    ...
    xlim(-5, 300) +
    ylim(0, 100))
(cair_greening_curves <- cair_greening_curves  + theme(legend.position = "none"))
...
(klu_greening_curves <- phenocam %>%
    ...
    xlim(-5, 100) +
    ylim(0, 100))
(klu_greening_curves <- klu_greening_curves  + theme(legend.position = "none"))
...
(brew_greening_curves <- phenocam %>%
    ...
    xlim(-5, 60) +
    ylim(0, 100))  
(brew_greening_curves <- brew_greening_curves  + theme(legend.position = "none"))
...
(nw_greening_curves <- phenocam %>%
    ...
    xlim(-5, 150) +
    ylim(0, 100)) 
(nw_greening_curves <- nw_greening_curves  + theme(legend.position = "none"))
